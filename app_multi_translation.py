...
def load_models(lang_pair, device="cpu"):
    ...
    if lang_pair == models_type[0]:
        ct_model_path = "output/ctranslate/tf_base_bpe_1.5k"
        sp_source_model_path = "output/bpe/02_bpe_1.5k/tokens.authentic.ind.model"
        sp_target_model_path = "output/bpe/02_bpe_1.5k/tokens.authentic.wlo.model"
    # tf_base_5.0k
    elif lang_pair == models_type[1]:
        ct_model_path = "output/ctranslate/tf_base_bpe_5.0k"
        sp_source_model_path = "output/bpe/04_bpe_5k/tokens.authentic.ind.model"
        sp_target_model_path = "output/bpe/04_bpe_5k/tokens.authentic.wlo.model"
    # tf_opt_1.0k
    elif lang_pair == models_type[2]:
        ct_model_path = "output/ctranslate/tf_opt_bpe_1.0k"
        sp_source_model_path = "output/bpe/01_bpe_1k/tokens.authentic.ind.model"
        sp_target_model_path = "output/bpe/01_bpe_1k/tokens.authentic.wlo.model"
    # tf_opt_0.5k + itbt
    elif lang_pair == models_type[3]:
        ct_model_path = "output/ctranslate/tf_opt_bpe_0.5k_itbt"
        sp_source_model_path = "output/bpe/05_bt_0.5k/tokens.authentic.ind.it.bt.model"
        sp_target_model_path = "output/bpe/05_bt_0.5k/tokens.authentic.wlo.it.bt.model"
    # tf_opt_0.5k + bpd
    elif lang_pair == models_type[4]:
